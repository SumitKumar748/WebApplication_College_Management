...
<div id="maindiv" style="margin:0px;height:auto;" >
 ...
 <div class="background" style="border:box-shadow: 0 5px 10px rgba(0,0,0,0.15);
    ...
    <div class="container" style="height:650px;">
	    <form action="teacherlogin" method="post">
	               ...
	               <label class="l1" style="text-decoration:underline;color:white;font-size:65px;">Password</label>
	                <input class="i1" name="tpwd" placeholder="Enter Password" type="password" required><br>
